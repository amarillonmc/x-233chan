/*! Kusaba X - BBCode Buttons by Mario Junior (Leptossomico) */
var imageTag=false;var theSelection=false;var form_name="postform";var text_name="message";var clientPC=navigator.userAgent.toLowerCase();var clientVer=parseInt(navigator.appVersion);var is_ie=((clientPC.indexOf('msie')!=-1)&&(clientPC.indexOf('opera')==-1));var is_win=((clientPC.indexOf('win')!=-1)||(clientPC.indexOf('16bit')!=-1));var baseHeight;var bbtags=new Array('[b]','[/b]','[i]','[/i]','[u]','[/u]','[quote]','[/quote]','[s]','[/s]','[list]','[/list]','[list=]','[/list]','[img]','[/img]','[url]','[/url]','[spoiler]','[/spoiler]');var bbcode=new Array();function helpline(help)
